...
| [Trader Memory Core]({{ '/en/skills/trader-memory-core/' | relative_url }}) ★ | Persistent thesis lifecycle tracker: register screener outputs, manage state transitions, attach position sizing, and generate postmortem reports | <span class="badge badge-optional">FMP Optional</span> |
